package io.github.mkobit.gradle.test.kotlin.io
  ...
  internal fun original() = testFactory<Unit> {
    ...
    test("CharSequence_length throws UnsupportedOperationException") {
      expectThrows<UnsupportedOperationException> {
        ...
        .isNotNull()
        .contains("Cannot access length from io.github.mkobit.gradle.test.kotlin.io.Original")
    }
    ...
    test("CharSequence_get throws UnsupportedOperationException") {
      expectThrows<UnsupportedOperationException> {
        ...
        .isNotNull()
        .contains("Cannot call get from io.github.mkobit.gradle.test.kotlin.io.Original")
    }
    ...
    test("CharSequence_subSequence throws UnsupportedOperationException") {
      expectThrows<UnsupportedOperationException> {
        ...
        .isNotNull()
        .contains("Cannot call subSequence from io.github.mkobit.gradle.test.kotlin.io.Original")
    }
  }
