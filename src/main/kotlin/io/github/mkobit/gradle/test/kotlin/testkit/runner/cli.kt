...
@Deprecated("Renamed to buildCache", ReplaceWith("buildCache", "io.github.mkobit.gradle.test.kotlin.testkit.runner.buildCache"), DeprecationLevel.ERROR)
...
@Deprecated("Renamed to noBuildScan", ReplaceWith("noBuildCache", "io.github.mkobit.gradle.test.kotlin.testkit.runner.noBuildCache"), DeprecationLevel.ERROR)
...
@Deprecated("Renamed to buildScan", ReplaceWith("buildScan", "io.github.mkobit.gradle.test.kotlin.testkit.runner.buildScan"), DeprecationLevel.ERROR)
...
@Deprecated("Renamed to noBuildScan", ReplaceWith("noBuildScan", "io.github.mkobit.gradle.test.kotlin.testkit.runner.noBuildScan"), DeprecationLevel.ERROR)
