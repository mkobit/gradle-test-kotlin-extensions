 ...
 */
@Deprecated("Superfluous method, will be removed in a future release", replaceWith = ReplaceWith("projectDirPath?.resolve", "com.mkobit.gradle.test.kotlin.testkit.runner.FsKt.projectDirPath"))
